import type { ColorRGB, DominantColorsResult } from './types';

const collectPixels = (imageData: ImageData): ColorRGB[] => {
...
const medianCut = (pixels: ColorRGB[], depth: number): ColorRGB[] => {
...
const boostSaturation = ([r, g, b]: ColorRGB, factor: number): ColorRGB => {
...
const luminance = ([r, g, b]: ColorRGB): number => 0.299 * r + 0.587 * g + 0.114 * b;

const FALLBACK_COLORS: ColorRGB[] = [
  [160, 80, 120],
  [255, 116, 116],
  [255, 196, 124],
  [140, 190, 255],
...
export const getDominantColors = (image: HTMLImageElement): DominantColorsResult => {
